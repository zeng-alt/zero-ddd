...
create sequence main_expression_seq start with 10 increment by 50;
    
create sequence main_permission_seq start with 10 increment by 50;
    
create sequence main_resource_seq start with 10 increment by 50;
    
create sequence main_role_permission_seq start with 10 increment by 50;
    
create sequence main_role_precondition_seq start with 10 increment by 50;
    
create sequence main_role_seq start with 10 increment by 50;
    
create sequence main_user_expression_seq start with 10 increment by 50;
    
create sequence main_user_group_role_seq start with 10 increment by 50;
    
create sequence main_user_group_seq start with 10 increment by 50;
    
create sequence main_user_group_user_seq start with 10 increment by 50;
    
create sequence main_user_resource_seq start with 10 increment by 50;
    
create sequence main_user_role_seq start with 10 increment by 50;
    
create sequence main_user_seq start with 10 increment by 50;
    
create sequence main_user_session_seq start with 10 increment by 50;
...
values
    (0, '{bcrypt}$2a$10$8xbX8CngT8AO8froAt8Ky.VDSzhxSFpIZlp4aO.XKnX3g3tGbj/QO', '0', '${tenantName}', 'admin', 1);
insert into
    main_user
(deleted, password, status, tenant_by, username, id)
values
    (0, '{bcrypt}$2a$10$mbJbeoem4jwjn2ADRQHqQeyy39SHnn37.TNsWknBA8upQzdhWUPQK', '0', '${tenantName}', 'root', 2);