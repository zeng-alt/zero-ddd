 ...
 */
public record EntityMutationFetcherConfigurer(
    ...
    public void configure(RuntimeWiring.Builder builder) {
        builder.type("Mutation", typeWiring -> {
            for (BaseRepository repository : repositories) {
                ...
                typeWiring.dataFetcher("save" + type, MutationDataFetcher.builder(repository, template).save(entityContext.getSaveHandlers(type.getName()), validator));
