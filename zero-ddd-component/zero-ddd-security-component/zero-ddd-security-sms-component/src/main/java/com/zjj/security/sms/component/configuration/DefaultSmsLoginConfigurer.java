 ...
 */
public class DefaultSmsLoginConfigurer extends AbstractLoginConfigurer<DefaultSmsLoginConfigurer, HttpSecurity, SmsAuthenticationFilter> {

    private SmsLoginProperties smsLoginProperties;


    public DefaultSmsLoginConfigurer(SmsLoginProperties smsLoginProperties, SmsAuthenticationFilter smsAuthenticationFilter) {
        super(smsAuthenticationFilter);
        this.smsLoginProperties = smsLoginProperties;
        smsAuthenticationFilter.setRequiresAuthenticationRequestMatcher(createLoginProcessingUrlMatcher(smsLoginProperties.getUrl()));
    ...
    public DefaultSmsLoginConfigurer processingUrl(String loginProcessingUrl) {
        getAuthenticationFilter().setRequiresAuthenticationRequestMatcher(createLoginProcessingUrlMatcher(loginProcessingUrl));
        return this;
    }
