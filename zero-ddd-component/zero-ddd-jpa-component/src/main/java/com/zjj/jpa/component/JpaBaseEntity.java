...
//    private @Transient EntityManager entityManager;
    ...
    public Option<T> findById() {
        return Option.of(ApplicationContextHelper.getBean(EntityManager.class).find((Class<T>) this.getClass(), getId()));
    }
    ...
    public Page<T> pageByList(int page, int pageSize) {
        ...
        // 添加排序条件，例如按创建日期降序排列
//        criteriaQuery.where(criteriaBuilder.equal(root.get("entityType"), this.getClass().getSimpleName()));
